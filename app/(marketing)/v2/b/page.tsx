...
// v2 title option B — headline in Fraunces at a light weight (not bold). Keeps
// Fraunces' character but far more delicate, so it sits comfortably next to the
// italic "safe" instead of overpowering it.
  ...
  return (
    <main className="relative min-h-screen overflow-hidden px-6 pt-28 pb-24 text-center sm:pt-36">
      ...
      <div className="relative mx-auto max-w-3xl">
        ...
        <h1 className="mt-9 font-display text-[3.4rem] font-light leading-[1.03] tracking-[-0.02em] text-ivory sm:text-8xl">
          Is your app{" "}
        ...
        <p className="mt-6 font-mono text-xs uppercase tracking-[0.16em] text-ash">Fraunces — light</p>
      </div>
    </main>
  );
}
