...
export const PLANS: Record<PlanId, Plan> = {
  free: {
    ...
    name: "Free",
    priceMonthly: 0,
    tagline: "For solo work and trying it out.",
    checksPerMonth: 100,
    repoLimit: 1,
    seats: 1,
    cta: "Start free",
    features: [
      "1 repository",
      "100 checks / month",
      "Tests, security scan & your rules",
      "✓ Assayed / ⚠ Held on every PR",
    ],
  },
  pro: {
    id: "pro",
    name: "Pro",
    priceMonthly: 19,
    tagline: "For indie devs shipping every day.",
    checksPerMonth: 2000,
    repoLimit: null,
    seats: 1,
    cta: "Upgrade to Pro",
    ...
    features: [
      ...
      "2,000 checks / month",
      "Repo-aware AI review (embeddings)",
      "Sandboxed test runs",
      "Priority check queue",
    ],
  },
  team: {
    id: "team",
